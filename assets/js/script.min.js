...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        if (filtered.length === 0) {
            resultsContainer.innerHTML = `
                <div class="p-4 text-sm text-gray-500 text-center bg-white">
            ...
            resultsContainer.innerHTML = filtered.map(item => {
                ...
                return `
                    <a href="${fullUrl}" class="block p-4 hover:bg-gray-50 border-b border-gray-100 last:border-none transition duration-150 no-underline text-left bg-white">
